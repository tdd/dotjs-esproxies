import{d as _,a3 as u,z as f,f as n,g as t,t as s,J as c,F as h,ai as g,o as i,i as v,e as x,ac as b}from"../modules/vue-CY3OsIzI.js";import{a as y,u as N}from"../index-Bvn82Oky.js";import{a as m}from"../monaco/bundled-types-rvj1b6yg.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-D7AQvKaL.js";import"../modules/shiki-Bsyf5hhV.js";import"../modules/file-saver-BzOOqXCn.js";const w={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},z={class:"opacity-50"},C={key:0,class:"border-main mb-8"},J=_({__name:"print",setup(D){const{slides:p,total:d}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
